...
import RegisterForm from "../section/authentication/RegisterForm";
    ...
    <RootStyle title="Register | Minimal-UI">
      ...
      <SectionStyle sx={{ display: { xs: "none", md: "flex" } }}>
        <Typography variant="h3" sx={{ px: 5, mt: 10, mb: 5 }}>
          Register to our Vendor Dashboard and Get Started
        </Typography>
        ...
        <ContentStyle>
          <Box sx={{ mb: 5 }}>
            ...
            <Typography sx={{ color: "text.secondary" }}>
              Gain access to Vendor Dashboard now
            </Typography>
          </Box>
          ...
          >
            By registering, I agree to Poorvika&nbsp;
