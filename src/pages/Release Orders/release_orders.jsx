import { Button, Card, CardActions, CardContent, Grid, Typography,Stack,Box,IconButton,Modal } from "@mui/material";
...
const ROrders = (props) => {
 ...
 const showDetail = (id) => {
  ...
  axios.get(`http://10.8.1.170:4545/api/v1/ro_list/${id}`).then((response)=>{
...
<IconButton aria-label="delete" color="error" size="large" onClick={() => deleteVendor(id)}>
  ...
  return (
    <Page title="Poorvika | Release Order">
       ...
       <Typography variant="h5" color="initial"><Box  sx={{ fontWeight: 'bold', m: 1 }}>Release Orders Table </Box></Typography>
        </Stack>  <Box 
